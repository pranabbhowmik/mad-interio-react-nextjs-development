    ...
    <div className="advance-card feature-card">
      ...
      <NoSsr>
        <Slider className="feature-slider" {...featureSlider}>
          <div>
            <Img
              src="https://sheltos-react-sooty.vercel.app/assets/images/property/4.jpg"
              className="bg-img"
              alt=""
            />
          ...
          <div>
            <Img
              src="https://sheltos-react-sooty.vercel.app/assets/images/property/16.jpg"
              className="bg-img"
              alt=""
            />
            <div className="bottom-feature">
          ...
          <div>
            <Img
              src="https://sheltos-react-sooty.vercel.app/assets/images/property/14.jpg"
              className="bg-img"
              alt=""
            />
            <div className="bottom-feature">
