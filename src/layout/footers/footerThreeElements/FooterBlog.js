              ...
              <div className="media">
                <Link href="/pages/blog-page/left-sidebar">
                  <div className="img-overlay">
                    <img
                      src="https://sheltos-react-sooty.vercel.app/assets/images/footer/1.jpg"
                      alt=""
                    />
                  </div>
                </Link>
            ...
            <div>
              <div className="media">
                <Link href="/pages/blog-page/left-sidebar">
                  <div className="img-overlay">
                    <img
                      src="https://sheltos-react-sooty.vercel.app/assets/images/footer/2.jpg"
                      alt=""
                    />
                  </div>
                </Link>
            ...
            <div>
              <div className="media">
                <Link href="/pages/blog-page/left-sidebar">
                  <div className="img-overlay">
                    <img
                      src="https://sheltos-react-sooty.vercel.app/assets/images/footer/3.jpg"
                      alt=""
                    />
                  </div>
                </Link>
            ...
            <div>
              <div className="media">
                <Link href="/pages/blog-page/left-sidebar">
                  <div className="img-overlay">
                    <img
                      src="https://sheltos-react-sooty.vercel.app/assets/images/footer/4.jpg"
                      alt=""
                    />
                  </div>
                </Link>
