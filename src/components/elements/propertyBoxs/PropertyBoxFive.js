        ...
        <ul className="icon-property">
            ...
            <div className="d-flex">
              <div className="property-icon">
                <svg className="property-svg">
                  <use xlinkHref="https://sheltos-react-sooty.vercel.app/assets/svg/icons.svg#home-heart"></use>
                </svg>
              </div>
              <span>{data?.home}</span>
            </div>
          ...
          <li>
            <div className="d-flex">
              <div className="property-icon">
                <svg className="property-svg">
                  <use xlinkHref="https://sheltos-react-sooty.vercel.app/assets/svg/icons.svg#ruler"></use>
                </svg>
              </div>
        ...
        <ul className="icon-property mb-0">
          <li>
            <div className="d-flex">
              <div className="property-icon">
                <svg className="property-svg">
                  <use xlinkHref="https://sheltos-react-sooty.vercel.app/assets/svg/icons.svg#key"></use>
                </svg>
              </div>
          ...
          <li>
            <div className="d-flex">
              <div className="property-icon">
                <svg className="property-svg">
                  <use xlinkHref="https://sheltos-react-sooty.vercel.app/assets/svg/icons.svg#safety"></use>
                </svg>
              </div>
              <span>{data?.date}</span>
            </div>
