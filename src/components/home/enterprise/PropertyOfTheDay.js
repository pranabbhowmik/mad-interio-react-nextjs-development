...
const PropertyOfTheDaySection = ({ value }) => {
  const img = [
    "https://sheltos-react-sooty.vercel.app/assets/images/1.jpg",
    "https://sheltos-react-sooty.vercel.app/assets/images/2.jpg",
    "https://sheltos-react-sooty.vercel.app/assets/images/4.jpg",
    "https://sheltos-react-sooty.vercel.app/assets/images/3.jpg",
  ];
                  ...
                  <div className="feature-content">
                    ...
                    <ul className="detail-list">
                      <li>
                        <div className="d-flex">
                          <span className="label label-light label-lg">
                            <img
                              src="https://sheltos-react-sooty.vercel.app/assets/images/icon/bed.png"
                      ...
                      <li>
                        <div className="d-flex">
                          <span className="label label-light label-lg">
                            <img
                              src="https://sheltos-react-sooty.vercel.app/assets/images/icon/bathroom.png"
                              className="img-fluid img-icon"
                              alt=""
                            />
                          </span>
                    ...
                    <ul className="feature-price">
                      <li>
                        <h3>
                          {symbol}
                          {(value?.price * currencyValue).toFixed(2) ||
