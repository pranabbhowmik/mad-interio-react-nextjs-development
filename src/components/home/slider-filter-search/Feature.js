                            ...
                            <div className="feature-left">
                              <div className="property-details">
                                ...
                                <ul>
                                  <li>
                                    <img
                                      src="https://sheltos-react-sooty.vercel.app/assets/images/svg/icon/double-bed.svg"
                                      className="img-fluid"
                                      alt=""
                                    />
                                    Bed : {data.bed}
                                  ...
                                  <li>
                                    <img
                                      src="https://sheltos-react-sooty.vercel.app/assets/images/svg/icon/bathroom.svg"
                                      className="img-fluid"
                                      alt=""
                                    />
                                    Baths : {data.baths}
                                  ...
                                  <li>
                                    <img
                                      src="https://sheltos-react-sooty.vercel.app/assets/images/svg/icon/square-ruler-tool.svg"
                          ...
                          <Col xl="8" lg="9" className="order-md">
                            <div className="feature-image">
                              ...
                              <span className="signature">
                                <img
                                  src="https://sheltos-react-sooty.vercel.app/assets/images/signature/1.png"
                                  alt=""
                                />
                              </span>
